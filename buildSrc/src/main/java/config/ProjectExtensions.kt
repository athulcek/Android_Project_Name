...
fun Project.addAndroidNetworkClient() {
    dependencies {
        // add("implementation", Deps.OK_HTTP3)
        //add("implementation", Deps.RETROFIT)
        add("implementation", Deps.Ktor.KTOR_ANDROID)
        add("implementation", Deps.Ktor.KTOR_CIO)
        add("implementation", Deps.Ktor.KTOR_SERIALIZATION)
    }
}

fun Project.addKtorCore() {
    dependencies {
        add("implementation", Deps.Ktor.KTOR_CORE)
    }
}
...
fun Project.addLivePreference() {
    dependencies {
       //  add("implementation", Deps.LIVE_PREFERENCES)
    }
}
...
fun Project.addAndroid() {
    dependencies {
        ...
        add("implementation", Deps.ANDROIDX_STARTUP_RUNTIME)
